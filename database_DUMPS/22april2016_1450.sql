...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-04-22 12:10:19.311746',1,'admin@admin.si','','','admin@admin.si',0,1,'0000-00-00 00:00:00.000000'),(2,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-04-22 12:49:19.897147',0,'test@test.si','','','test@test.si',0,1,'0000-00-00 00:00:00.000000'),(3,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-04-22 12:49:25.977541',0,'doc@test.si','','','doc@test.si',0,1,'0000-00-00 00:00:00.000000'),(4,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=',NULL,0,'test1@test.si','','','test1@test.si',0,1,'0000-00-00 00:00:00.000000'),(5,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=',NULL,0,'zobar@test.si','','','zobar@test.si',0,1,'0000-00-00 00:00:00.000000');
...
INSERT INTO `django_content_type` VALUES (1,'admin','logentry'),(3,'auth','group'),(2,'auth','permission'),(4,'auth','user'),(7,'authtoken','token'),(5,'contenttypes','contenttype'),(8,'corsheaders','corsmodel'),(6,'sessions','session'),(14,'tpo','ambulanta'),(21,'tpo','bolezni'),(17,'tpo','dieta'),(24,'tpo','iplock'),(23,'tpo','meritev'),(18,'tpo','navodiladieta'),(11,'tpo','osebje'),(15,'tpo','posta'),(20,'tpo','pregled'),(16,'tpo','roles'),(12,'tpo','sifrantregistriranih'),(9,'tpo','uporabnik'),(13,'tpo','ustanova'),(22,'tpo','vrednostimeritev'),(19,'tpo','zdravilo'),(10,'tpo','zdravnik');
...
INSERT INTO `tpo_sifrantregistriranih` VALUES (1,1000),(2,1010),(3,1020),(4,6780);
...
INSERT INTO `tpo_uporabnik` VALUES (1,'Administrator','1','0000-00-00','','',NULL,'M',NULL,0,NULL,NULL,1),(2,'Janko','Novak','0000-00-00','Celje','Topniška ulica 13',123456789,'M','AB+',0,NULL,1000,4),(4,'Maja','Novak','0000-00-00','','',878787878,'Z','B',0,NULL,NULL,4);
...
CREATE TABLE `tpo_zdravnik` (
  ...
  `ambulanta_id` int(11) DEFAULT NULL,
  `medicinske_sestre_id` int(11) DEFAULT NULL,
  `role_id` int(11) NOT NULL,
  `sifra_id` int(11) NOT NULL,
  `ustanova_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`user_ptr_id`),
  KEY `tpo_zdravnik_ambulanta_id_77018836_fk_tpo_ambulanta_id` (`ambulanta_id`),
  KEY `tpo_zdra_medicinske_sestre_id_d511d4d8_fk_tpo_osebje_user_ptr_id` (`medicinske_sestre_id`),
  ...
  CONSTRAINT `tpo_zdra_medicinske_sestre_id_d511d4d8_fk_tpo_osebje_user_ptr_id` FOREIGN KEY (`medicinske_sestre_id`) REFERENCES `tpo_osebje` (`user_ptr_id`),
...
INSERT INTO `tpo_zdravnik` VALUES (3,'Darko','Dravinski','dr. med.','osebni',1,10,1,NULL,2,1,1),(5,'Maja','Miklavc','dr. zoboprotetike','zobozdravnik',1,4,2,NULL,2,2,2);
...
-- Dump completed on 2016-04-22 14:51:16
