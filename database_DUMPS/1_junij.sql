...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-05-05 20:03:57',1,'admin@admin.si','','','admin@admin.si',0,1,'2015-04-22 12:10:19'),(2,'pbkdf2_sha256$24000$pwcW26CVPges$8eHzgfJHcTW7jXabHCvCQpC5CnuJsQcxj+ryYGb+6Xs=','2016-05-08 19:14:04',0,'test@test.si','','','test@test.si',0,1,'2015-04-22 12:10:19'),(3,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-05-06 12:31:32',0,'doc@test.si','','','doc@test.si',1,1,'2015-04-22 12:10:19'),(4,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-05-05 21:50:00',0,'test1@test.si','','','test1@test.si',0,1,'2015-04-22 12:10:19'),(5,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-04-25 21:43:47',0,'zobar@test.si','','','zobar@test.si',1,1,'2015-04-22 12:10:19'),(6,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=',NULL,0,'sestra@test.si','','','sestra@test.si',1,1,'2015-04-22 12:10:19'),(7,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-05-05 19:55:28',0,'prazen@test.si','','','prezen@test.si',0,1,'0000-00-00 00:00:00'),(8,'pbkdf2_sha256$24000$t0HwstLTjFu9$z/21MLcDqZ+AxbHyPWO2FkW0kGHLLPQ6n6z2yU8fX24=','2016-05-05 20:09:26',0,'doc2@test.si','','','doc2@test.si',1,1,'2016-05-05 20:07:30'),(9,'pbkdf2_sha256$24000$j48dE7GcMGEX$fvr8K7CWTNbxfjs0cfE4XylThNBAR2Lekggu8wMZ4tY=','2016-05-05 20:08:48',0,'dohtar@test.si','','','dohtar@test.si',1,1,'2016-05-05 20:08:36'),(10,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=',NULL,0,'abc@test.si','','','abc@test.si',0,1,'0000-00-00 00:00:00'),(11,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=',NULL,0,'xyz@test.si','','','xyz@test.si',0,1,'0000-00-00 00:00:00');
...
CREATE TABLE `tpo_uporabnik` (
  ...
  KEY `tpo_uporabnik_personalizacija_id` (`personalizacija_id`),
  ...
  CONSTRAINT `tpo_uporabnik_personalizacija_id` FOREIGN KEY (`personalizacija_id`) REFERENCES `tpo_personalizacijanadzorneplosce` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION,
...
INSERT INTO `tpo_uporabnik` VALUES (1,'Administrator','1','0000-00-00 00:00:00','','',NULL,'Moški',NULL,0,NULL,NULL,1,NULL,NULL,NULL),(2,'Janko','Novak','2016-06-03 22:00:00','Celje','Topniška ulica 130',123456789,'Moški','AB+',0,NULL,3000,4,'051555666',1,NULL),(4,'Maja','Novak','2016-10-04 22:00:00','Celje','Jamborjeva 133',9203190,'Ženski','B',0,NULL,3000,4,'0391203910',28,NULL),(7,'Jerica','Kos','2016-03-04 23:00:00','Jesenice','Bled 12',2132133,'Ženski',NULL,0,NULL,2000,4,'051776382',NULL,NULL),(10,'','',NULL,'','',NULL,'',NULL,0,NULL,NULL,4,NULL,NULL,NULL),(11,'','',NULL,'','',NULL,'',NULL,0,NULL,NULL,4,NULL,NULL,NULL);
...
-- Dump completed on 2016-06-01 12:15:56
