...
--
-- Table structure for table `tpo_zdravila_navodila`
--

DROP TABLE IF EXISTS `tpo_zdravila_navodila`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tpo_zdravila_navodila` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `zdravila_id` int(11) NOT NULL,
  `navodilazdravila_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tpo_zdravila_navodila_zdravila_id_ae4c696f_uniq` (`zdravila_id`,`navodilazdravila_id`),
  ...
  CONSTRAINT `tpo_zdravila_id` FOREIGN KEY (`zdravila_id`) REFERENCES `tpo_zdravilo` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=14 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tpo_zdravila_navodila`
--

LOCK TABLES `tpo_zdravila_navodila` WRITE;
/*!40000 ALTER TABLE `tpo_zdravila_navodila` DISABLE KEYS */;
/*!40000 ALTER TABLE `tpo_zdravila_navodila` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-06-07 17:46:06
