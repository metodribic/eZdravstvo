...
INSERT INTO `auth_user` VALUES (1,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-04-25 22:00:13.245360',1,'admin@admin.si','','','admin@admin.si',0,1,'2015-04-22 12:10:19.311746'),(2,'pbkdf2_sha256$24000$pwcW26CVPges$8eHzgfJHcTW7jXabHCvCQpC5CnuJsQcxj+ryYGb+6Xs=','2016-05-05 13:18:11.639379',0,'test@test.si','','','test@test.si',0,1,'2015-04-22 12:10:19.311746'),(3,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-05-05 13:01:33.301158',0,'doc@test.si','','','doc@test.si',1,1,'2015-04-22 12:10:19.311746'),(4,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-05-05 12:46:45.646915',0,'test1@test.si','','','test1@test.si',0,1,'2015-04-22 12:10:19.311746'),(5,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=','2016-05-05 13:16:56.176246',0,'zobar@test.si','','','zobar@test.si',1,1,'2015-04-22 12:10:19.311746'),(6,'pbkdf2_sha256$24000$57Yuhx3LYR5c$/Mnf5vRoMky/AL38imTepBSZunwzNcs74qz5r4SZtsE=',NULL,0,'sestra@test.si','','','sestra@test.si',1,1,'2015-04-22 12:10:19.311746'),(7,'pbkdf2_sha256$24000$bl3ME9U9vO0l$RShO94JYFhNFzd0Y/7BeEu7HE2qFmSOdlxJc8ICYw5s=',NULL,0,'test2@test.si','Jan','Novak','test2@test.si',0,1,'2016-04-11 12:23:31.000000');
...
INSERT INTO `authtoken_token` VALUES ('269b8ba00c93bee639482939bb4c5058f5fa31d6','2016-04-22 16:59:01.857208',4),('42e7d1e5cf16a473f653933c9a90a740a4e59826','2016-04-22 11:12:48.602391',1),('69c3792c488f41bfa0b34ada027d8c855f9e90b5','2016-04-22 11:20:01.566745',2),('ccf52a194032fef802c1260b213e6d13197ea3e5','2016-04-22 17:36:25.881754',5),('ce4766d9bf891e8d8ee22b42c957cb3d2c2353d0','2016-04-22 12:49:25.973359',3);
...
INSERT INTO `tpo_kontaktnaoseba` VALUES (1,'Janez','Novakovič','Velika Planina 155b','Tast',1001,'+4421321312'),(2,'Matej','Novak','Topniška ulica 13','Brat',1000,'312312312');
...
INSERT INTO `tpo_meritev` VALUES (1,'5','2016-04-12',1,2);
...
--
-- Table structure for table `tpo_oskrbovanec`
--

DROP TABLE IF EXISTS `tpo_oskrbovanec`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tpo_oskrbovanec` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `ime` varchar(100) NOT NULL,
  `priimek` varchar(100) NOT NULL,
  ...
  `role_id` int(11) NOT NULL,
  `oskrbnik_id` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
  KEY `tpo_oskrbovanec_ambulanta_id_975e6764_fk_tpo_ambulanta_id` (`ambulanta_id`),
  KEY `tpo_oskrbov_kontaktna_oseba_id_7f1266ee_fk_tpo_kontaktnaoseba_id` (`kontaktna_oseba_id`),
  KEY `tpo_oskrbovanec_posta_id_a2b17759_fk_tpo_posta_id` (`posta_id`),
  KEY `tpo_oskrbovanec_role_id_38e37a6a_fk_tpo_roles_id` (`role_id`),
  KEY `tpo_oskrbovanec_93180a7a` (`oskrbnik_id`),
  CONSTRAINT `tpo_oskrbov_kontaktna_oseba_id_7f1266ee_fk_tpo_kontaktnaoseba_id` FOREIGN KEY (`kontaktna_oseba_id`) REFERENCES `tpo_kontaktnaoseba` (`id`),
  CONSTRAINT `tpo_oskrbovane_oskrbnik_id_4d57dfa9_fk_tpo_uporabnik_user_ptr_id` FOREIGN KEY (`oskrbnik_id`) REFERENCES `tpo_uporabnik` (`user_ptr_id`),
  CONSTRAINT `tpo_oskrbovanec_ambulanta_id_975e6764_fk_tpo_ambulanta_id` FOREIGN KEY (`ambulanta_id`) REFERENCES `tpo_ambulanta` (`id`),
  CONSTRAINT `tpo_oskrbovanec_posta_id_a2b17759_fk_tpo_posta_id` FOREIGN KEY (`posta_id`) REFERENCES `tpo_posta` (`id`),
  CONSTRAINT `tpo_oskrbovanec_role_id_38e37a6a_fk_tpo_roles_id` FOREIGN KEY (`role_id`) REFERENCES `tpo_roles` (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=2 DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tpo_oskrbovanec`
--

LOCK TABLES `tpo_oskrbovanec` WRITE;
/*!40000 ALTER TABLE `tpo_oskrbovanec` DISABLE KEYS */;
INSERT INTO `tpo_oskrbovanec` VALUES (1,'Miha','Pavliha','0000-00-00','Jesenice','Koper 12',45454545,'M','B-',0,NULL,1,2,5000,4,2);
/*!40000 ALTER TABLE `tpo_oskrbovanec` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tpo_oskrbovanec_bolezni`
--

DROP TABLE IF EXISTS `tpo_oskrbovanec_bolezni`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tpo_oskrbovanec_bolezni` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `oskrbovanec_id` int(11) NOT NULL,
  `bolezni_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tpo_oskrbovanec_bolezni_oskrbovanec_id_16e2337f_uniq` (`oskrbovanec_id`,`bolezni_id`),
  KEY `tpo_oskrbovanec_bolezni_bolezni_id_4126e1b4_fk_tpo_bolezni_id` (`bolezni_id`),
  CONSTRAINT `tpo_oskrbovanec_bo_oskrbovanec_id_903502ab_fk_tpo_oskrbovanec_id` FOREIGN KEY (`oskrbovanec_id`) REFERENCES `tpo_oskrbovanec` (`id`),
  CONSTRAINT `tpo_oskrbovanec_bolezni_bolezni_id_4126e1b4_fk_tpo_bolezni_id` FOREIGN KEY (`bolezni_id`) REFERENCES `tpo_bolezni` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tpo_oskrbovanec_bolezni`
--

LOCK TABLES `tpo_oskrbovanec_bolezni` WRITE;
/*!40000 ALTER TABLE `tpo_oskrbovanec_bolezni` DISABLE KEYS */;
/*!40000 ALTER TABLE `tpo_oskrbovanec_bolezni` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tpo_oskrbovanec_dieta`
--

DROP TABLE IF EXISTS `tpo_oskrbovanec_dieta`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tpo_oskrbovanec_dieta` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `oskrbovanec_id` int(11) NOT NULL,
  `dieta_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tpo_oskrbovanec_dieta_oskrbovanec_id_d1b33f36_uniq` (`oskrbovanec_id`,`dieta_id`),
  KEY `tpo_oskrbovanec_dieta_dieta_id_55fa0d76_fk_tpo_dieta_id` (`dieta_id`),
  CONSTRAINT `tpo_oskrbovanec_di_oskrbovanec_id_612e54af_fk_tpo_oskrbovanec_id` FOREIGN KEY (`oskrbovanec_id`) REFERENCES `tpo_oskrbovanec` (`id`),
  CONSTRAINT `tpo_oskrbovanec_dieta_dieta_id_55fa0d76_fk_tpo_dieta_id` FOREIGN KEY (`dieta_id`) REFERENCES `tpo_dieta` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tpo_oskrbovanec_dieta`
--

LOCK TABLES `tpo_oskrbovanec_dieta` WRITE;
/*!40000 ALTER TABLE `tpo_oskrbovanec_dieta` DISABLE KEYS */;
/*!40000 ALTER TABLE `tpo_oskrbovanec_dieta` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tpo_oskrbovanec_zdravila`
--

DROP TABLE IF EXISTS `tpo_oskrbovanec_zdravila`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tpo_oskrbovanec_zdravila` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `oskrbovanec_id` int(11) NOT NULL,
  `zdravilo_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tpo_oskrbovanec_zdravila_oskrbovanec_id_f36cc2f8_uniq` (`oskrbovanec_id`,`zdravilo_id`),
  KEY `tpo_oskrbovanec_zdravila_zdravilo_id_5683cb90_fk_tpo_zdravilo_id` (`zdravilo_id`),
  CONSTRAINT `tpo_oskrbovanec_zd_oskrbovanec_id_10c37abd_fk_tpo_oskrbovanec_id` FOREIGN KEY (`oskrbovanec_id`) REFERENCES `tpo_oskrbovanec` (`id`),
  CONSTRAINT `tpo_oskrbovanec_zdravila_zdravilo_id_5683cb90_fk_tpo_zdravilo_id` FOREIGN KEY (`zdravilo_id`) REFERENCES `tpo_zdravilo` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tpo_oskrbovanec_zdravila`
--

LOCK TABLES `tpo_oskrbovanec_zdravila` WRITE;
/*!40000 ALTER TABLE `tpo_oskrbovanec_zdravila` DISABLE KEYS */;
/*!40000 ALTER TABLE `tpo_oskrbovanec_zdravila` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `tpo_oskrbovanec_zdravnik`
--

DROP TABLE IF EXISTS `tpo_oskrbovanec_zdravnik`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `tpo_oskrbovanec_zdravnik` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `oskrbovanec_id` int(11) NOT NULL,
  `zdravnik_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tpo_oskrbovanec_zdravnik_oskrbovanec_id_361d1a4c_uniq` (`oskrbovanec_id`,`zdravnik_id`),
  KEY `tpo_oskrbovanec_zdravnik_id_8b5cf143_fk_tpo_zdravnik_user_ptr_id` (`zdravnik_id`),
  CONSTRAINT `tpo_oskrbovanec_zd_oskrbovanec_id_6222c2dc_fk_tpo_oskrbovanec_id` FOREIGN KEY (`oskrbovanec_id`) REFERENCES `tpo_oskrbovanec` (`id`),
  CONSTRAINT `tpo_oskrbovanec_zdravnik_id_8b5cf143_fk_tpo_zdravnik_user_ptr_id` FOREIGN KEY (`zdravnik_id`) REFERENCES `tpo_zdravnik` (`user_ptr_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tpo_oskrbovanec_zdravnik`
--

LOCK TABLES `tpo_oskrbovanec_zdravnik` WRITE;
/*!40000 ALTER TABLE `tpo_oskrbovanec_zdravnik` DISABLE KEYS */;
/*!40000 ALTER TABLE `tpo_oskrbovanec_zdravnik` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `tpo_pregled` (
  ...
  `meritve_id` int(11) NOT NULL,
  `uporabnik_id` int(11) NOT NULL,
  `zdravnik_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  KEY `tpo_pregled_meritve_id_431078bd_fk_tpo_meritev_id` (`meritve_id`),
  KEY `tpo_pregled_f9585d13` (`uporabnik_id`),
  KEY `tpo_pregled_8352a122` (`zdravnik_id`),
  CONSTRAINT `tpo_pregled_meritve_id_431078bd_fk_tpo_meritev_id` FOREIGN KEY (`meritve_id`) REFERENCES `tpo_meritev` (`id`),
...
INSERT INTO `tpo_pregled` VALUES (1,'Pojesti manj sladkarij','2016-04-12','0000-00-00',1,2,3),(2,'Zdravniški pregled','2015-05-11','0000-00-00',1,4,5);
...
INSERT INTO `tpo_sifrantregistriranih` VALUES (1,1000,1),(2,1010,1),(3,1020,0),(4,6001,1),(5,7000,0),(6,7001,0),(7,7002,0),(8,8000,0),(9,8001,0);
...
INSERT INTO `tpo_uporabnik` VALUES (1,'Administrator','1','0000-00-00 00:00:00.000000','','',NULL,'Moški',NULL,0,NULL,NULL,1,NULL,NULL),(2,'Janko','Novak','2016-06-03 22:00:00.000000','Celje','Topniška ulica 130',123456789,'Moški','AB+',0,NULL,3000,4,'051555666',1),(4,'Maja','Novak','0000-00-00 00:00:00.000000','Celje','',12121212,'Ženski','B',0,NULL,NULL,4,NULL,NULL),(7,'Jana','Novak','1999-12-30 00:00:00.000000','Ljubljana','Topniska ulica 53',12153,'M','AB+',0,NULL,1000,4,'041-123-456',2);
...
INSERT INTO `tpo_uporabnik_oskrbovanci` VALUES (1,2,7);
...
CREATE TABLE `tpo_uporabnik_zdravnik` (
  ...
  `zdravnik_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
  UNIQUE KEY `tpo_uporabnik_zdravnik_uporabnik_id_a8304f81_uniq` (`uporabnik_id`,`zdravnik_id`),
  KEY `tpo_uporabnik_z_zdravnik_id_532cd06d_fk_tpo_zdravnik_user_ptr_id` (`zdravnik_id`),
...
INSERT INTO `tpo_uporabnik_zdravnik` VALUES (4,2,3),(6,2,5),(3,7,3);
...
INSERT INTO `tpo_zdravnik` VALUES (3,'Darko','Dravinski','dr. med.','osebni',1,9,1,2,1,1,'+3865346356'),(5,'Maja','Miklavc','dr. zoboprotetike','zobozdravnik',1,0,2,2,2,1,'041444111');
...
INSERT INTO `tpo_zdravnik_medicinske_sestre` VALUES (1,3,6);
...
-- Dump completed on 2016-05-05 15:20:01
